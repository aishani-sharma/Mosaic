    ...
    <div className="relative h-screen min-h-[100svh] w-full overflow-hidden flex flex-col justify-center items-center select-none font-sans bg-[#faf6ef]">
      <div className="fixed inset-0 z-0 overflow-hidden">
        ...
        <div
          ...
          style={{
            background: "radial-gradient(circle at center, rgba(255, 250, 244, 0.8) 0%, rgba(255, 250, 244, 0.46) 52%, rgba(245, 239, 230, 0.18) 100%)",
            pointerEvents: "none"
          }}
        />
      </div>
      ...
      <div className="relative z-10 mt-80 text-center px-6 max-w-xl animate-fade-in flex flex-col items-center">
        <button
          ...
          style={{
            ...
            borderColor: "rgba(115, 120, 125, 0.18)",
            backdropFilter: "blur(14px)",
            WebkitBackdropFilter: "blur(14px)",
            color: "#18252d",
          }}
          onMouseOver={e => {
            e.currentTarget.style.background = "rgba(255, 250, 244, 0.96)";
            e.currentTarget.style.borderColor = "rgba(115, 120, 125, 0.24)";
          }}
          onMouseOut={e => {
            e.currentTarget.style.background = "rgba(255, 250, 244, 0.9)";
            e.currentTarget.style.borderColor = "rgba(115, 120, 125, 0.18)";
          }}
        >
      ...
      {showModal && (
        ...
        >
          <div
            ...
            style={{
              background: "linear-gradient(to bottom, rgba(255, 251, 246, 0.96), rgba(250, 244, 236, 0.92))",
          ...
          >
            <h2 className="font-serif-display font-semibold text-2xl text-[#18252d] mb-2 text-center">
              Welcome to Mosaic
            </h2>
            <p className="text-xs text-[#53626b] text-center mb-8 uppercase tracking-[0.24em] font-mono">
              Calm Productivity
            </p>
            ...
            <button
              ...
              style={{
                ...
                border: "1px solid rgba(115, 120, 125, 0.14)",
                color: "#111827",
                opacity: isFirebaseConfigured ? 1 : 0.68,
              }}
              onMouseOver={e => {
            ...
            <div className="flex items-center gap-3 w-full my-5">
              ...
              <span className="text-xs text-[#53626b] font-bold uppercase tracking-wider font-mono">or</span>
              <div className="flex-1 h-px bg-[#6f7d84]/15" />
            </div>
