  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6" style={{ background: "#0a0a0f" }}>
      <div
        ...
        style={{ background: "radial-gradient(ellipse at 50% 35%, rgba(124,106,247,0.1) 0%, transparent 60%)" }}
      />
      ...
      <div className="w-full max-w-sm relative">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="font-display font-black text-3xl mb-1" style={{ color: "#f0eeff" }}>Clutch</h1>
