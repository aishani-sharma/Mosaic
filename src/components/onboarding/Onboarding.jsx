        ...
        <div className="flex flex-col gap-2">
          {ROLES.map(r => (
            <button
              ...
              style={{
                background: data.role === r ? "rgba(100, 189, 227,0.2)" : "rgba(255,255,255,0.04)",
                border: `1px solid ${data.role === r ? "rgba(100, 189, 227,0.5)" : "rgba(255,255,255,0.08)"}`,
        ...
        <div className="flex flex-wrap gap-2">
          {FOCUS_AREAS.map(f => (
            <button
              ...
              style={{
                background: data.focusAreas.includes(f) ? "rgba(100, 189, 227,0.2)" : "rgba(255,255,255,0.04)",
                border: `1px solid ${data.focusAreas.includes(f) ? "rgba(100, 189, 227,0.5)" : "rgba(255,255,255,0.08)"}`,
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6" style={{ background: "#0a0a0f" }}>
      ...
      <div className="fixed inset-0 pointer-events-none" style={{
        background: "radial-gradient(ellipse at 50% 40%, rgba(100, 189, 227,0.08) 0%, transparent 60%)"
      }} />
        ...
        <div className="flex items-center gap-2 mb-8 justify-center">
          {steps.map((_, i) => (
            <div
              ...
              style={{
                width: i === step ? 32 : 8,
                background: i <= step ? "#64BDE3" : "rgba(255,255,255,0.1)",
              }}
            />
          ))}
        </div>
        ...
        <GlassCard className="p-7">
          ...
          <div className="mb-6">
            <div className="flex items-center gap-2 mb-1">
              <Sparkles size={16} style={{ color: "#64BDE3" }} />
              <span className="text-xs font-mono" style={{ color: "#64BDE3" }}>
